...
function mobiletto(driverPath, key, secret, opts, encryption) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (!client.redisConfig.prefix) {
            client.redisConfig.prefix = redis_js_1.REDIS_PREFIX;
        }
        ...
        const metaLoadQueue = () => {
            if (!client.mq) {
                ...
                const port = client.redisConfig.port || parseInt(`${redis_js_1.REDIS_PORT}`);
                const queueOptions = {
                    connection: {
                        host: client.redisConfig.host || redis_js_1.REDIS_HOST,
                        port,
                    },
