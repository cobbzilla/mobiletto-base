...
exports.flushAll = exports.teardown = exports.MobilettoCache = exports.getRedis = exports.REDIS_PREFIX = exports.REDIS_PORT = exports.REDIS_HOST = void 0;
...
class MobilettoCache {
    constructor(name, host = "127.0.0.1", port = 6379, prefix = "_mobiletto__") {
        ...
        this.get = (key) => __awaiter(this, void 0, void 0, function* () {
            this.counters.get++;
            mobiletto_common_1.logger.silly(`redis(${this.name}) get(${key}) starting`);
            const val = yield this.doRedis((r) => r.get(this.pfx(key)), null);
            mobiletto_common_1.logger.silly(`redis(${this.name}) get(${key}) found value: ${val}`);
            if (val) {
                this.counters.hit++;
            }
            else {
        ...
        this.set = (key, val, expirationMillis = DEFAULT_EXPIRATION_MILLIS) => __awaiter(this, void 0, void 0, function* () {
            this.counters.set++;
            mobiletto_common_1.logger.silly(`redis(${this.name}) set(${key}, ${val}, ${expirationMillis}) starting`);
            yield this.doRedisAsync((r) => r.set(this.pfx(key), JSON.stringify(val), "EX", expirationMillis / 1000));
            mobiletto_common_1.logger.silly(`redis(${this.name}) set(${key}, ${val}, ${expirationMillis}) finished`);
        });
        ...
        this.scopedCache = (name, size = 100) => {
            ...
            if (!this.redis) {
                return new cache_js_1.AwaitableLRU(size && size > 0 ? size : 100);
            }
                ...
                set: (key, value) => __awaiter(this, void 0, void 0, function* () {
                    if (key && value) {
                        try {
                            ...
                            if (rk)
                                yield this.set(rk, JSON.stringify(value));
                        }
                        catch (e) {
        ...
        if (host && port) {
            try {
                this.redis = new ioredis_1.default(Object.assign({}, RedisOptions_1.DEFAULT_REDIS_OPTIONS, { host, port }));
            }
            catch (e) {
...
exports.MobilettoCache = MobilettoCache;
...
const teardown = () => __awaiter(void 0, void 0, void 0, function* () {
    return yield forAllCaches((client) => __awaiter(void 0, void 0, void 0, function* () {
        try {
            ...
            mobiletto_common_1.logger.warn(`teardown: error disconnecting from redis(${client.name}) ${e}`);
        }
    }));
});
exports.teardown = teardown;
const flushAll = () => __awaiter(void 0, void 0, void 0, function* () { return yield forAllCaches((client) => __awaiter(void 0, void 0, void 0, function* () { return client.flush(); })); });
