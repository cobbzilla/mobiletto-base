...
const RedisOptions_js_1 = require("ioredis/built/redis/RedisOptions.js");
...
class MobilettoCache {
    constructor(name, host = "127.0.0.1", port = 6379, prefix = "_mobiletto__") {
        ...
        if (host && port) {
            try {
                this.redis = new ioredis_1.default(Object.assign({}, RedisOptions_js_1.DEFAULT_REDIS_OPTIONS, { host, port }));
            }
            catch (e) {
